    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 text-slate-900 px-6 font-sans">
      <div className="w-full max-w-md">
        ...
        <header className="mb-8">
          ...
          <p className="text-slate-500">Welcome back. Please login to sync your volumes.</p>
        </header>
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
          ...
          <div className="mt-8 text-center">
            <Link to="/register" className="text-slate-500 hover:text-slate-950 font-semibold transition-colors">
